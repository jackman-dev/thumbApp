...
def resize_and_pad(image_path, output_path, crop_size, final_width, final_height):
    try:
...
def select_folder_and_process():
    ...
    for filename in images:
        ...
        resize_and_pad(input_path, output_path, crop_size, final_width, final_height)
